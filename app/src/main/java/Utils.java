package com.example.kevin.bluetooth;
...
import com.example.kevin.bluetooth.BuildConfig;

public class Utils {

    public static void log(String message) {
        if (BuildConfig.DEBUG) {
            if (message != null) Log.i(com.example.kevin.bluetooth.Const.TAG, message);
        }
    }
    ...
    public static String getPrefence(Context context, String item) {
        ...
        return settings.getString(item, com.example.kevin.bluetooth.Const.TAG);
    }
